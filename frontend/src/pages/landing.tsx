    ...
    <div className="relative min-h-screen font-sans selection:bg-primary/20 text-foreground overflow-hidden">
      ...
      {mobileMenuOpen && (
        <div className="liquid-glass p-6 flex flex-col gap-6 md:hidden text-center shadow-lg absolute left-0 right-0 top-full z-50 rounded-b-3xl border-t-0 mt-2 mx-4">
          ...
          <Link to="/admin/login" className="text-foreground uppercase text-xs tracking-widest font-semibold liquid-glass py-3 mx-4" onClick={() => setMobileMenuOpen(false)}>Admin Login</Link>
        </div>
      )}
      ...
      <section id="about" className="relative z-10 py-24 px-6 md:px-12 lg:px-16 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="relative liquid-glass p-2 shadow-sm flex items-center justify-center min-h-[400px]">
      ...
      <section id="collection" className="relative z-10 py-24 bg-transparent px-6 md:px-12 lg:px-16 border-t border-foreground/5">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {/* Card 1 */}
            <div className="liquid-glass flex flex-col group transition duration-200 hover:shadow-xl hover:-translate-y-2 cursor-pointer focus-visible:ring-3 focus-visible:ring-primary/50 outline-none active:scale-[0.98]" tabIndex={0}>
          ...
          <div className="mt-16 w-full liquid-glass p-2 flex flex-col md:flex-row gap-4">
            ...
            <div className="w-full md:w-2/3 h-[300px] md:h-auto bg-white relative overflow-hidden flex-shrink-0">
              <iframe 
