    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-200 pb-20">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl sm:text-4xl font-display font-semibold text-foreground tracking-tight">Add Product</h1>
            <p className="text-muted-foreground mt-2 text-sm sm:text-base">Add a new brass product to your inventory</p>
          </div>
        </div>
