        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredProducts.map((product) => (
            <div
              ...
              onKeyDown={(e) => { if (e.key === 'Enter') router.push(`/admin/products/${product.id}/edit`) }}
          ...
          {filteredProducts.length === 0 && (
            <div className="col-span-full py-16 text-center liquid-glass rounded-3xl flex flex-col items-center justify-center">
              ...
              <Button onClick={() => router.push("/admin/products/new")}><Plus className="h-4 w-4 mr-2" /> Add Product</Button>
            </div>
          )}
        </div>
      )}
